...
public class TileEntityEnderChest extends TileEntity { // CloudSpigot - remove IUpdatePlayerListBox
    ...
    public void c() {
        // CloudSpigot start - Move enderchest sound handling out of the tick loop
        /*
        if (++this.h % 20 * 4 == 0) {
    ...
    public void b() {
        ...
        // CloudSpigot start - Move enderchest open sounds out of the tick loop
        if (this.g > 0 && this.a == 0.0F) {
            this.a = 0.7F;
