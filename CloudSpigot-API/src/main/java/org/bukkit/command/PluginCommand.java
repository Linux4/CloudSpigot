...
public final class PluginCommand extends Command implements PluginIdentifiableCommand {
    ...
    public java.util.List<String> tabComplete(CommandSender sender, String alias, String[] args) throws CommandException, IllegalArgumentException {
        return tabComplete(sender, alias, args, null); // CloudSpigot - The code from this method has been (slightly modified) moved to the Location method.
    }

    // CloudSpigot start - location tab-completes
    /**
    ...
    public List<String> tabComplete(CommandSender sender, String alias, String[] args, Location location) throws CommandException, IllegalArgumentException {
        ...
        try {
            if (completer != null) {
                completions = completer.onTabComplete(sender, this, alias, args, location); // CloudSpigot - add location argument
            }
            if (completions == null && executor instanceof TabCompleter) {
                completions = ((TabCompleter) executor).onTabComplete(sender, this, alias, args, location); // CloudSpigot - add location argument
            }
        } catch (Throwable ex) {
