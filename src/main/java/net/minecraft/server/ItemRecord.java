...
public class ItemRecord extends Item {
	...
	public boolean interactWith(ItemStack itemstack, EntityHuman entityhuman, World world, BlockPosition blockposition,
		...
		/*
		 * if (iblockdata.getBlock() == Blocks.JUKEBOX && !((Boolean)
		 * iblockdata.get(BlockJukeBox.HAS_RECORD)).booleanValue()) { if
		 * (world.isClientSide) { return true; } else { // CraftBukkit Start /*
		 ...
		 */ // CloudSpigot
		return iblockdata.getBlock() == Blocks.JUKEBOX && !iblockdata.get(BlockJukeBox.HAS_RECORD).booleanValue();
