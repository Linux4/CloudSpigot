...
public abstract class Entity implements ICommandListener {
	...
	public Entity(World world) {
		...
		this.length = 1.8F;
		this.h = 1;
		this.random = SHARED_RANDOM; // CloudSpigot
		this.maxFireTicks = 1;
	...
	/**
	 * CloudSpigot - Checks if the feature is enabled and the entity is above the
	 * nether world bedrock height
	 */
	private boolean paperNetherCheck() {
		return this.world.cloudSpigotConfig.netherVoidTopDamage
	...
	public void K() {
		...
		if (!this.world.isClientSide && this.world instanceof WorldServer) {
			...
			// MinecraftServer minecraftserver = ((WorldServer)
			// this.world).getMinecraftServer(); // CloudSpigot
			int i = this.L();
		...
		if (this.locY < -64.0D || paperNetherCheck()) { // CloudSpigot - Configurable top-of-nether void damage
			this.O();
		}
	...
	/**
	 * CloudSpigot - Load surrounding chunks the entity is moving through
	 */
	...
	public void move(double d0, double d1, double d2) {
		if (this.loadChunks)
			loadChunks(); // CloudSpigot - Load chunks
		if (this.noclip) {
			...
			if (this.s_() && !flag && this.vehicle == null) {
				...
				/*
				 * if (block != null && this.onGround) { // block.a(this.world, blockposition,
				 * this); // CraftBukkit moved down }
				 */ // CloudSpigot
	...
	public void mount(Entity entity) {
		...
		if (entity == null) {
			if (this.vehicle != null) {
				...
				// CraftBukkit end
				// CloudSpigot start - make EntityDismountEvent cancellable
