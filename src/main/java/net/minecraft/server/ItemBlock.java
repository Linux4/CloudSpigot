...
public class ItemBlock extends Item {
	...
	public boolean interactWith(ItemStack itemstack, EntityHuman entityhuman, World world, BlockPosition blockposition,
		...
		if (itemstack.count == 0) {
			...
			return false;
		} else if (world.a(this.a, blockposition, false, enumdirection, entityhuman, itemstack)) { // CloudSpigot - Pass
																									// entityhuman
																									// instead of null
			...
			if (world.setTypeAndData(blockposition, iblockdata1, 3)) {
				...
				world.makeSound((double) ((float) blockposition.getX() + 0.5F),
						(double) ((float) blockposition.getY() + 0.5F), (double) ((float) blockposition.getZ() + 0.5F),
