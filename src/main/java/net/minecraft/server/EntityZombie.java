...
public class EntityZombie extends EntityMonster {
    ...
    private static final AttributeModifier c = new AttributeModifier(EntityZombie.b, "Baby speed boost", eu.server24_7.cloudspigot.CloudSpigotConfig.babyZombieMovementSpeed, 1); // CloudSpigot - Configurable baby zombie movement speed
