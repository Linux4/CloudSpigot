...
public class BlockFlowing extends BlockFluids {
	...
	public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
		...
		int j = this.getFlowSpeed(world, blockposition); // CloudSpigot
		int k;
		...
		if (i > 0) {
			...
			if (!world.cloudSpigotConfig.fastDrainLava && this.material == Material.LAVA && i < 8 && i1 < 8 && i1 > i
					&& random.nextInt(4) != 0) { // CloudSpigot
				j *= 4;
			}
		...
		if (world.getType(blockposition).getBlock().getMaterial() != material)
			return; // CloudSpigot - Stop updating flowing block if material has changed
		...
		if (this.h(world, blockposition.down(), iblockdata2)) {
			...
			Iterator<EnumDirection> iterator1 = set.iterator();

			while (iterator1.hasNext()) {
				EnumDirection enumdirection1 = iterator1.next();
	...
	public void onPlace(World world, BlockPosition blockposition, IBlockData iblockdata) {
		if (!this.e(world, blockposition, iblockdata)) {
			world.a(blockposition, this, this.getFlowSpeed(world, blockposition)); // CloudSpigot
		}

	}

	/**
	 * CloudSpigot - Get flow speed. Throttle if its water and flowing adjacent to
	 * lava
	 */
	public int getFlowSpeed(World world, BlockPosition blockposition) {
		if (this.getMaterial() == Material.LAVA) {
			return world.worldProvider.o() ? world.cloudSpigotConfig.lavaFlowSpeedNether
					: world.cloudSpigotConfig.lavaFlowSpeedNormal;
		}
	...
	/**
	 * CloudSpigot - Data check method for fast draining
	 */
	...
	/**
	 * CloudSpigot - Checks surrounding blocks to determine if block can be fast
	 * drained
	 */
