...
public class BlockFlowing extends BlockFluids {
    ...
    public void b(World world, BlockPosition blockposition, IBlockData iblockdata, Random random) {
        ...
        if (world.getType(blockposition).getBlock().getMaterial() != material) return; // CloudSpigot - Stop updating flowing block if material has changed
    ...
    /**
     * CloudSpigot - Get flow speed. Throttle if its water and flowing adjacent to lava
     */
    ...
    /**
     * CloudSpigot - Checks surrounding blocks to determine if block can be fast drained
     */
