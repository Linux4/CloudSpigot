...
public final class ItemStack {
	...
	public void setData(int i) {
        ...
        // Is this a block?
        // CloudSpigot start - Allow specific blocks to retain their data values
        int id = CraftMagicNumbers.getId(this.getItem());
        if (CraftMagicNumbers.getBlock(id) != Blocks.AIR) {
            // If vanilla doesn't use data on it don't allow any
            if ((CloudSpigotConfig.dataValueAllowedItems == null || !CloudSpigotConfig.dataValueAllowedItems.contains(id)) &&
