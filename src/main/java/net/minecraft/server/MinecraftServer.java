...
public abstract class MinecraftServer
		implements Runnable, ICommandListener, IAsyncTaskHandler/* , IMojangStatistics */ { // CloudSpigot

	public static final Logger LOGGER = LogManager.getLogger();
	public static final File a = new File("usercache.json");
	private static MinecraftServer l;
	public Convertable convertable;
	// private final MojangStatisticsGenerator n = new
	// MojangStatisticsGenerator("server", this, az());
	...
	public MinecraftServer(OptionSet options, Proxy proxy, File file1) {
		 ...
		 * Main.useJline = false; }
		 * 
		 * try { reader = new ConsoleReader(System.in, System.out);
		 * reader.setExpandEvents(false); // Avoid parsing exceptions for uncommonly
		 * used event designators } catch (Throwable e) { try { // Try again with jline
		 * disabled for Windows users without C++ 2008 Redistributable
		 * System.setProperty("jline.terminal", "jline.UnsupportedTerminal");
		 * System.setProperty("user.language", "en"); Main.useJline = false; reader =
		 * new ConsoleReader(System.in, System.out); reader.setExpandEvents(false); }
		 * catch (IOException ex) { LOGGER.warn((String) null, ex); } }
		 */
		// CloudSpigot end
	...
	protected void A() throws ExceptionWorldConflict { // CraftBukkit - added throws
		...
		if (this.T) {
			this.T = false;
			/*
			 * this.methodProfiler.a = true; this.methodProfiler.a();
			 */ // CloudSpigot
		}
		...
		// this.methodProfiler.b(); // CloudSpigot
		/*
		 * this.methodProfiler.a("snooper"); if (getSnooperEnabled() && !this.n.d() &&
		 * this.ticks > 100) { // Spigot this.n.a(); }
		 * 
		 * if (getSnooperEnabled() && this.ticks % 6000 == 0) { // Spigot this.n.b(); }
		 * 
	...
	public void B() {
		...
		for (i = 0; i < this.worlds.size(); ++i) {
			...
			/*
			 * Drop global time updates if (this.ticks % 20 == 0) {
			 * this.methodProfiler.a("timeSync"); this.v.a(new
			 * PacketPlayOutUpdateTime(worldserver.getTime(), worldserver.getDayTime(),
			 * worldserver.getGameRules().getBoolean("doDaylightCycle")),
			 * worldserver.worldProvider.getDimension()); this.methodProfiler.b(); } //
			 * CraftBukkit end
			 */
			...
			/*
			 * this.methodProfiler.b(); this.methodProfiler.a("tracker");
			 */ // CloudSpigot
	...
	public String getServerModName() {
		return "CloudSpigot"; // CloudSpigot - CloudSpigot > // Spigot - Spigot > // CraftBukkit - cb >
								// vanilla!
	}
	...
	public List<String> tabCompleteCommand(ICommandListener icommandlistener, String s, BlockPosition blockposition) {
		 ...
		 * return arraylist; }
		 */
		return server.tabComplete(icommandlistener, s, blockposition); // CloudSpigot - add Location argument
		// CraftBukkit end
	}
	...
	public void a(MojangStatisticsGenerator mojangstatisticsgenerator) {
		 ...
		 * mojangstatisticsgenerator.a("whitelist_count", Integer.valueOf(0)); if
		 * (this.v != null) { mojangstatisticsgenerator.a("players_current",
		 * Integer.valueOf(this.I())); mojangstatisticsgenerator.a("players_max",
		 * Integer.valueOf(this.J())); mojangstatisticsgenerator.a("players_seen",
		 * Integer.valueOf(this.v.getSeenPlayers().length)); }
		 * 
		 * mojangstatisticsgenerator.a("uses_auth", this.onlineMode);
		 * mojangstatisticsgenerator.a("gui_state", this.as() ? "enabled" : "disabled");
		 * mojangstatisticsgenerator.a("run_time", Long.valueOf((az() -
		 * mojangstatisticsgenerator.g()) / 60L * 1000L));
		 * mojangstatisticsgenerator.a("avg_tick_ms", Integer.valueOf((int)
		 * (MathHelper.a(this.h) * 1.0E-6D))); int i = 0;
		 * 
		 * if (this.worldServer != null) { // CraftBukkit start for (int j = 0; j <
		 * this.worlds.size(); ++j) { WorldServer worldserver = this.worlds.get(j); if
		 * (worldserver != null) { // CraftBukkit end WorldData worlddata =
		 * worldserver.getWorldData();
		 * 
		 * mojangstatisticsgenerator.a("world[" + i + "][dimension]",
		 * Integer.valueOf(worldserver.worldProvider.getDimension()));
		 * mojangstatisticsgenerator.a("world[" + i + "][mode]",
		 * worlddata.getGameType()); mojangstatisticsgenerator.a("world[" + i +
		 * "][difficulty]", worldserver.getDifficulty());
		 * mojangstatisticsgenerator.a("world[" + i + "][hardcore]",
		 * worlddata.isHardcore()); mojangstatisticsgenerator.a("world[" + i +
		 * "][generator_name]", worlddata.getType().name());
		 * mojangstatisticsgenerator.a("world[" + i + "][generator_version]",
		 * Integer.valueOf(worlddata.getType().getVersion()));
		 * mojangstatisticsgenerator.a("world[" + i + "][height]",
		 * Integer.valueOf(this.F)); mojangstatisticsgenerator.a("world[" + i +
		 * "][chunks_loaded]", Integer.valueOf(worldserver.N().getLoadedChunks())); ++i;
		 * } } }
		 * 
	...
	public void b(MojangStatisticsGenerator mojangstatisticsgenerator) {
		 ...
		 * mojangstatisticsgenerator.b("gui_supported", GraphicsEnvironment.isHeadless()
		 * ? "headless" : "supported"); mojangstatisticsgenerator.b("dedicated",
		 * this.ae());
		 */
		// CloudSpigot end
	}
