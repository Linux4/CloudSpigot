...
public class PathfinderGoalHurtByTarget extends PathfinderGoalTarget {
	...
	public void c() {
		...
		if (this.a) {
			double d0 = this.f();
			List<? extends EntityCreature> list = this.e.world.a(this.e.getClass(),
					(new AxisAlignedBB(this.e.locX, this.e.locY, this.e.locZ, this.e.locX + 1.0D, this.e.locY + 1.0D,
							this.e.locZ + 1.0D)).grow(d0, 10.0D, d0));
