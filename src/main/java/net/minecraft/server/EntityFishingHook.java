...
public class EntityFishingHook extends Entity {
	...
	public void t_() {
		...
		if (this.az > 0) {
			...
			// CloudSpigot start - Allow fishing hooks to fly through vanished players the
			// shooter can't see
						...
						if (this.ax > 0) {
							...
							if (this.ax <= 0) {
								...
								worldserver.a(EnumParticle.WATER_BUBBLE, this.locX, f3 + 1.0F, this.locZ,
										...
										this.width, 0.20000000298023224D, new int[0]);
							...
							this.aw = MathHelper.nextInt(this.random, this.world.cloudSpigotConfig.fishingMinTicks,
									this.world.cloudSpigotConfig.fishingMaxTicks); // CloudSpigot - Configurable fishing
																					// tick range
