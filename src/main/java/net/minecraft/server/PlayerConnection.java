...
public class PlayerConnection implements PacketListenerPlayIn, IUpdatePlayerListBox {
	...
	private void internalTeleport(double d0, double d1, double d2, float f, float f1,
			Set<EnumPlayerTeleportFlags> set) {
		if (Float.isNaN(f)) {
			f = 0;
		}
	...
	public void a(PacketPlayInBlockPlace packetplayinblockplace) {
		...
		if (CloudSpigotConfig.interactLimitEnabled && lastPlace != -1
	...
	public void a(PacketPlayInWindowClick packetplayinwindowclick) {
		...
		if (this.player.activeContainer.windowId == packetplayinwindowclick.a()
			...
			/*
			 * if (false) { // this.player.isSpectator()) { ArrayList arraylist =
			 * Lists.newArrayList();
			 * 
			 * for (int i = 0; i < this.player.activeContainer.c.size(); ++i) {
			 * arraylist.add(((Slot) this.player.activeContainer.c.get(i)).getItem()); }
			 * 
			 * this.player.a(this.player.activeContainer, (List) arraylist); } else {
			 */ // CloudSpigot
			// ItemStack itemstack =
							...
							if (clickedItem == null) {
								...
								if (cursor == null) {
									...
									if (clickedItem.doMaterialsMatch(cursor) && ItemStack.equals(clickedItem, cursor)) {
										...
										&& ItemStack.equals(cursor, clickedItem) && clickedItem.count >= 0
										&& clickedItem.count + cursor.count <= cursor.getMaxStackSize()) { // CloudSpigot
			...
			if (packetplayinwindowclick.f() != 5) {
				...
				case DEFAULT:
					...
					if (itemstack != null && ((itemstack.getItem() == Items.LAVA_BUCKET
							&& CloudSpigotConfig.stackableLavaBuckets)
							|| (itemstack.getItem() == Items.WATER_BUCKET && CloudSpigotConfig.stackableWaterBuckets)
							|| (itemstack.getItem() == Items.MILK_BUCKET && CloudSpigotConfig.stackableMilkBuckets))) {
			...
			if (ItemStack.matches(packetplayinwindowclick.e(), itemstack)) {
				this.player.playerConnection.sendPacket(
						new PacketPlayOutTransaction(packetplayinwindowclick.a(), packetplayinwindowclick.d(), true));
				this.player.g = true;
				this.player.activeContainer.b();
				...
				this.player.playerConnection.sendPacket(
						new PacketPlayOutTransaction(packetplayinwindowclick.a(), packetplayinwindowclick.d(), false));
	...
	public void a(PacketPlayInUpdateSign packetplayinupdatesign) {
		...
		if (worldserver.isLoaded(blockposition)) {
			...
			for (int i = 0; i < aichatbasecomponent.length; ++i) {
				// CloudSpigot start - fix CrashSign
	...
	public void a(PacketPlayInTabComplete packetplayintabcomplete) {
		...
		Iterator<String> iterator = this.minecraftServer
		...
		this.player.playerConnection
				.sendPacket(new PacketPlayOutTabComplete(arraylist.toArray(new String[arraylist.size()])));
	}
