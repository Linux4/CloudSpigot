		...
		if (!this.world.isClientSide) {
			...
			if (movingobjectposition.entity != null) {
				...
				if (flag) {
					...
					// CraftBukkit start
					if (this.world.isEmpty(blockposition) && isIncendiary
							&& !org.bukkit.craftbukkit.event.CraftEventFactory.callBlockIgniteEvent(world,
									blockposition.getX(), blockposition.getY(), blockposition.getZ(), this)
									.isCancelled()) {
