...
public class BlockFire extends Block {
	...
	protected BlockFire() {
		super(Material.FIRE);
		this.j(this.blockStateList.getBlockData().set(BlockFire.AGE, Integer.valueOf(0)).set(BlockFire.FLIP, false)
				.set(BlockFire.ALT, false).set(BlockFire.NORTH, false).set(BlockFire.EAST, false)
				.set(BlockFire.SOUTH, false).set(BlockFire.WEST, false).set(BlockFire.UPPER, Integer.valueOf(0)));
		this.a(true);
	}
