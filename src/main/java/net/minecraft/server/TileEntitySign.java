...
public class TileEntitySign extends TileEntity {
	...
	public boolean b(final EntityHuman entityhuman) {
		/*
		 * ICommandListener icommandlistener = new ICommandListener() { public String
		 * getName() { return entityhuman.getName(); }
		 * 
		 * public IChatBaseComponent getScoreboardDisplayName() { return
		 * entityhuman.getScoreboardDisplayName(); }
		 * 
		 * public void sendMessage(IChatBaseComponent ichatbasecomponent) {}
		 * 
		 * public boolean a(int i, String s) { return i <= 2; }
		 * 
		 * public BlockPosition getChunkCoordinates() { return
		 * TileEntitySign.this.position; }
		 * 
		 * public Vec3D d() { return new Vec3D((double)
		 * TileEntitySign.this.position.getX() + 0.5D, (double)
		 * TileEntitySign.this.position.getY() + 0.5D, (double)
		 * TileEntitySign.this.position.getZ() + 0.5D); }
		 * 
		 * public World getWorld() { return entityhuman.getWorld(); }
		 * 
		 * public Entity f() { return entityhuman; }
		 * 
		 * public boolean getSendCommandFeedback() { return false; }
		 * 
		 * public void a(CommandObjectiveExecutor.EnumCommandResult
