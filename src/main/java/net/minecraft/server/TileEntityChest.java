...
public class TileEntityChest extends TileEntityContainer implements IInventory { // CloudSpigot - remove IUpdatePlayerListBox

    private ItemStack[] items = new ItemStack[27];
    public boolean a;
    public TileEntityChest f; // CloudSpigot - adjacentChestZNeg
    public TileEntityChest g; // CloudSpigot - adjacentChestXPos
    public TileEntityChest h; // CloudSpigot - adjacentChestXNeg
    public TileEntityChest i; // CloudSpigot - adjacentChestZPos
    ...
    public void c() {
        // CloudSpigot - Move chest sounds out of the tick loop
        /*
        this.m();
    ...
    public void startOpen(EntityHuman entityhuman) {
        if (!entityhuman.isSpectator()) {
            ...
            // CloudSpigot start - Move chest open sound out of the tick loop
            this.m();
    ...
    public void closeContainer(EntityHuman entityhuman) {
        if (!entityhuman.isSpectator() && this.w() instanceof BlockChest) {
            ...
            // CloudSpigot start - Move chest close sound handling out of the tick loop
            if (this.l == 0 && this.j > 0.0F || this.l > 0 && this.j < 1.0F) {
                float f = 0.1F;
