...
public class BlockVine extends Block {
	...
	public BlockVine() {
		...
		this.j(this.blockStateList.getBlockData().set(BlockVine.UP, false).set(BlockVine.NORTH, false)
				.set(BlockVine.EAST, false).set(BlockVine.SOUTH, false).set(BlockVine.WEST, false));
		this.a(true);
							...
							if (block.material == Material.AIR) {
								...
								if (flag1 && this.c(world.getType(blockposition3).getBlock())) {
									...
									CraftEventFactory.handleBlockSpreadEvent(bukkitBlock, source, this,
											toLegacyData(this.getBlockData().set(getDirection(enumdirection1), true)));
								} else if (flag2 && this.c(world.getType(blockposition4).getBlock())) {
									// world.setTypeAndData(blockposition2,
									// this.getBlockData().set(a(enumdirection2), true), 2);
									CraftEventFactory.handleBlockSpreadEvent(bukkitBlock, source, this,
											toLegacyData(this.getBlockData().set(getDirection(enumdirection2), true)));
									...
									// this.getBlockData().set(a(enumdirection.opposite()), true), 2);
									...
									CraftEventFactory.handleBlockSpreadEvent(bukkitBlock, source, this, toLegacyData(
											this.getBlockData().set(getDirection(enumdirection.opposite()), true)));
								...
								world.setTypeAndData(blockposition, iblockdata.set(getDirection(enumdirection), true),
										2);
							}
