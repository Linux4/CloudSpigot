	...
	public static class WorldGenJungleTemple extends WorldGenRegistration.WorldGenScatteredPiece {
		...
		public boolean a(World world, Random random, StructureBoundingBox structureboundingbox) {
			if (!this.a(world, structureboundingbox, 0)) {
				...
				this.a(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.ATTACHED, true), 2, -3, 8,
						structureboundingbox);
				this.a(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.ATTACHED, true), 3, -3, 8,
						structureboundingbox);
				...
				this.a(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.ATTACHED, true), 7, -3, 2,
						structureboundingbox);
				this.a(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.ATTACHED, true), 7, -3, 3,
						structureboundingbox);
				this.a(world, Blocks.TRIPWIRE.getBlockData().set(BlockTripwire.ATTACHED, true), 7, -3, 4,
						structureboundingbox);
