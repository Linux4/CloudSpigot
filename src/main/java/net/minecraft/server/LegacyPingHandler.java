	...
	public void channelRead(ChannelHandlerContext channelhandlercontext, Object object) throws Exception {
		...
		try {
			if (bytebuf.readUnsignedByte() == 254) {
				...
				switch (i) {
				case 0:
					LegacyPingHandler.a.debug("Ping: (<1.3.x) from {}:{}", new Object[] {
							inetsocketaddress.getAddress(), Integer.valueOf(inetsocketaddress.getPort()) });
					s = String.format("%s\u00a7%d\u00a7%d", new Object[] { minecraftserver.getMotd(),
							Integer.valueOf(minecraftserver.I()), Integer.valueOf(minecraftserver.J()) });
				...
				case 1:
					...
					LegacyPingHandler.a.debug("Ping: (1.4-1.5.x) from {}:{}", new Object[] {
							inetsocketaddress.getAddress(), Integer.valueOf(inetsocketaddress.getPort()) });
					s = String.format("\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d",
							new Object[] { Integer.valueOf(127), minecraftserver.getVersion(),
									minecraftserver.getMotd(), Integer.valueOf(minecraftserver.I()),
									Integer.valueOf(minecraftserver.J()) });
					this.a(channelhandlercontext, this.a(s));
					break;
				...
				default:
					...
					LegacyPingHandler.a.debug("Ping: (1.6) from {}:{}", new Object[] { inetsocketaddress.getAddress(),
