	...
	private static WorldGenVillagePieces.WorldGenVillagePiece c(
		...
		if (i1 <= 0) {
			...
			while (j1 < 5) {
				...
				Iterator<WorldGenVillagePieceWeight> iterator = worldgenvillagepieces_worldgenvillagestartpiece.e
						.iterator();

				while (iterator.hasNext()) {
					WorldGenVillagePieces.WorldGenVillagePieceWeight worldgenvillagepieces_worldgenvillagepieceweight = iterator
							.next();
