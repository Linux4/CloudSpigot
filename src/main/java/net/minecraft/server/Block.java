...
public class Block {
    ...
    public void onPlace(World world, BlockPosition blockposition, IBlockData iblockdata) {
        //org.spigotmc.AsyncCatcher.catchOp( "block onPlace"); // Spigot // CloudSpigot
    }

    public void remove(World world, BlockPosition blockposition, IBlockData iblockdata) {
        //org.spigotmc.AsyncCatcher.catchOp( "block remove"); // Spigot // CloudSpigot
    }
    ...
    public void a(World world, EntityHuman entityhuman, BlockPosition blockposition, IBlockData iblockdata, TileEntity tileentity) {
        ...
        entityhuman.applyExhaustion(world.cloudSpigotConfig.blockBreakExhaustion); // CloudSpigot - Configurable block break exhaustion
