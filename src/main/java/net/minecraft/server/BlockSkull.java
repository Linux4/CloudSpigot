...
public class BlockSkull extends BlockContainer {
	...
	public void updateShape(IBlockAccess iblockaccess, BlockPosition blockposition) {
		switch (BlockSkull.SyntheticClass_1.a[((EnumDirection) iblockaccess.getType(blockposition)
	...
	public void remove(World world, BlockPosition blockposition, IBlockData iblockdata) {
		if (!world.isClientSide) {
			...
			// CloudSpigot start
			/*
			 * if (false) { // CraftBukkit end TileEntity tileentity =
			 * world.getTileEntity(blockposition);
			 * 
			 * if (tileentity instanceof TileEntitySkull) { TileEntitySkull tileentityskull
			 * = (TileEntitySkull) tileentity; ItemStack itemstack = new
			 * ItemStack(Items.SKULL, 1, this.getDropData(world, blockposition));
			 * 
			 * if (tileentityskull.getSkullType() == 3 && tileentityskull.getGameProfile()
			 * != null) { itemstack.setTag(new NBTTagCompound()); NBTTagCompound
			 * nbttagcompound = new NBTTagCompound();
			 * 
			 * GameProfileSerializer.serialize(nbttagcompound,
			 * tileentityskull.getGameProfile()); itemstack.getTag().set("SkullOwner",
			 * nbttagcompound); }
			 * 
			 * a(world, blockposition, itemstack); } }
			 */
		...
		if (tileentityskull.getSkullType() == 1 && blockposition.getY() >= 2
			...
			if (shapedetector_shapedetectorcollection != null) {
				...
				entitywither.aI = shapedetector_shapedetectorcollection.b().k() == EnumDirection.EnumAxis.X ? 0.0F
						: 90.0F;
				entitywither.n();
				Iterator<EntityHuman> iterator = world
						.a(EntityHuman.class, entitywither.getBoundingBox().grow(50.0D, 50.0D, 50.0D)).iterator();
