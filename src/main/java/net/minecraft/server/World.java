...
public abstract class World implements IBlockAccess {
    ...
    //public final List<TileEntity> h = Lists.newArrayList(); // CloudSpigot - Remove unused list
    ...
    public void a(int i, int j, int k, int l) {
        ...
        if (!this.worldProvider.o()) {
            for (i1 = k; i1 <= l; ++i1) {
                this.updateLight(EnumSkyBlock.SKY, new BlockPosition(i, i1, j)); // CloudSpigot - Asynchronous lighting updates
            }
        }
    ...
    public List<AxisAlignedBB> getCubes(Entity entity, AxisAlignedBB axisalignedbb) {
        ...
        if (entity instanceof EntityItem) return arraylist; // CloudSpigot - Optimize item movement
    ...
    public void entityJoinedWorld(Entity entity, boolean flag) {
        ...
        if (!org.spigotmc.ActivationRange.checkIfActive(entity)) {
            ...
            if (!entity.ad || entity.ae != k || entity.af != l || entity.ag != i1) {
                if (entity.loadChunks) entity.loadChunks(); // CloudSpigot - Force load chunks
