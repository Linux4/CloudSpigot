...
public abstract class MobSpawnerAbstract {
    ...
    private int tickDelay = 0; // CloudSpigot
    ...
    private boolean g() {
        ...
        return this.a().isPlayerNearbyWhoAffectsSpawning((double) blockposition.getX() + 0.5D, (double) blockposition.getY() + 0.5D, (double) blockposition.getZ() + 0.5D, (double) this.requiredPlayerRange); // CloudSpigot - Affects Spawning API
    }
