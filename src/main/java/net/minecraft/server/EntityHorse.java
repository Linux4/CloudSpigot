...
public class EntityHorse extends EntityAnimal implements IInventoryListener {
	...
	// "textures/entity/horse/armor/horse_armor_diamond.png"}; // CloudSpigot
	...
	// "textures/entity/horse/horse_darkbrown.png"}; // CloudSpigot
	// private static final String[] by = new String[] { "hwh", "hcr", "hch", "hbr",
	// "hbl", "hgr", "hdb"}; // CloudSpigot
	...
	// "textures/entity/horse/horse_markings_blackdots.png"}; // CloudSpigot
	// private static final String[] bA = new String[] { "", "wo_", "wmo", "wdo",
	// "bdo"}; // CloudSpigot
	private int bB;
	private int bC;
	private int bD;
