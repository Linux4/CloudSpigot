...
public class BlockTripwire extends Block {
	...
	public BlockTripwire() {
		...
		this.j(this.blockStateList.getBlockData().set(BlockTripwire.POWERED, false).set(BlockTripwire.SUSPENDED, false)
				.set(BlockTripwire.ATTACHED, false).set(BlockTripwire.DISARMED, false).set(BlockTripwire.NORTH, false)
				.set(BlockTripwire.EAST, false).set(BlockTripwire.SOUTH, false).set(BlockTripwire.WEST, false));
	...
	public void onPlace(World world, BlockPosition blockposition, IBlockData iblockdata) {
		iblockdata = iblockdata.set(BlockTripwire.SUSPENDED,
				Boolean.valueOf(!World.a((IBlockAccess) world, blockposition.down())));
	...
	private void e(World world, BlockPosition blockposition) {
		...
		List<Entity> list = world.getEntities((Entity) null,
				new AxisAlignedBB((double) blockposition.getX() + this.minX, (double) blockposition.getY() + this.minY,
