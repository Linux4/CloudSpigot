    ...
    public void track(List<EntityHuman> list) {
        ...
        if (this.m % this.c == 0 || this.tracker.ai || this.tracker.getDataWatcher().a()) {
            ...
            if (this.tracker.vehicle == null) {
                ...
                if (this.m > 0 || this.tracker instanceof EntityArrow) { // CloudSpigot - Moved up
                ...
                if (object != null) {
                    // CloudSpigot start - ensure fresh viewers get an absolute position on their first update,
