...
public class EntityWolf extends EntityTameableAnimal {
	...
	public EntityWolf(World world) {
		...
		this.targetSelector.a(4,
				new PathfinderGoalRandomTargetNonTamed(this, EntityAnimal.class, false, new Predicate<Entity>() {
		...
		if (this.U()) {
			...
			if (this.bs > 0.4F) {
				...
				for (int j = 0; j < i; ++j) {
					...
					this.world.addParticle(EnumParticle.WATER_SPLASH, this.locX + (double) f1, (double) (f + 0.8F),
							this.locZ + (double) f2, this.motX, this.motY, this.motZ, new int[0]);
				}
			}
		}
