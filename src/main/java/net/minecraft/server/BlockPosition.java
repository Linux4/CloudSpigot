...
public class BlockPosition extends BaseBlockPosition {
	...
	public BlockPosition up(int i) {
		return i == 0 ? this : new BlockPosition(this.getX(), this.getY() + i, this.getZ()); // CloudSpigot - Optimize
																								// BlockPosition
	}
	...
	public BlockPosition north(int i) {
		return i == 0 ? this : new BlockPosition(this.getX(), this.getY(), this.getZ() - i); // CloudSpigot - Optimize
																								// BlockPosition)
	}
	...
	public BlockPosition west(int i) {
		return i == 0 ? this : new BlockPosition(this.getX() - i, this.getY(), this.getZ()); // CloudSpigot - Optimize
																								// BlockPosition
	}
	...
	public static Iterable<BlockPosition> a(BlockPosition blockposition, BlockPosition blockposition1) {
		// final BlockPosition blockposition2 = new
		// BlockPosition(Math.min(blockposition.getX(), blockposition1.getX()),
		// Math.min(blockposition.getY(), blockposition1.getY()),
		// Math.min(blockposition.getZ(), blockposition1.getZ())); // CloudSpigot
		// final BlockPosition blockposition3 = new
		// BlockPosition(Math.max(blockposition.getX(), blockposition1.getX()),
