...
public class BlockPosition extends BaseBlockPosition {
    ...
    public BlockPosition up() {
        return new BlockPosition(this.getX(), this.getY() + 1, this.getZ()); // CloudSpigot - Optimize BlockPosition
    }

    public BlockPosition up(int i) {
        return i == 0 ? this : new BlockPosition(this.getX(), this.getY() + i, this.getZ()); // CloudSpigot - Optimize BlockPosition
    }
    ...
    public BlockPosition north() {
        return new BlockPosition(this.getX(), this.getY(), this.getZ() - 1); // CloudSpigot - Optimize BlockPosition
    }

    public BlockPosition north(int i) {
        return i == 0 ? this : new BlockPosition(this.getX(), this.getY(), this.getZ() - i); // CloudSpigot - Optimize BlockPosition)
    }
    ...
    public BlockPosition west() {
        return new BlockPosition(this.getX() - 1, this.getY(), this.getZ()); // CloudSpigot - Optimize BlockPosition
    }

    public BlockPosition west(int i) {
        return i == 0 ? this : new BlockPosition(this.getX() - i, this.getY(), this.getZ()); // CloudSpigot - Optimize BlockPosition
    }
    ...
    public BlockPosition shift(EnumDirection enumdirection) {
        // CloudSpigot Start - Optimize BlockPosition
    ...
    public static Iterable<BlockPosition> a(BlockPosition blockposition, BlockPosition blockposition1) {
        //final BlockPosition blockposition2 = new BlockPosition(Math.min(blockposition.getX(), blockposition1.getX()), Math.min(blockposition.getY(), blockposition1.getY()), Math.min(blockposition.getZ(), blockposition1.getZ())); // CloudSpigot
        //final BlockPosition blockposition3 = new BlockPosition(Math.max(blockposition.getX(), blockposition1.getX()), Math.max(blockposition.getY(), blockposition1.getY()), Math.max(blockposition.getZ(), blockposition1.getZ())); // CloudSpigot
    ...
    public static final class MutableBlockPosition extends BlockPosition {
        ...
        // CloudSpigot start - remove our overriding variables
        /*
        private int c;
        private int d;
        private int e;
        */
        ...
        public MutableBlockPosition(int i, int j, int k) {
            super(0, 0, 0);
            // CloudSpigot start - modify base x,y,z
            this.setX(i);
            this.setY(j);
            this.setZ(k);
        }
