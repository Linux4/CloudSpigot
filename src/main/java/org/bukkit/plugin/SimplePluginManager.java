...
import eu.minewars.cloudspigot.exception.ServerEventException;
import eu.minewars.cloudspigot.exception.ServerPluginEnableDisableException;
...
public final class SimplePluginManager implements PluginManager {
	...
	public void registerEvent(Class<? extends Event> event, Listener listener, EventPriority priority,
		...
		/*
		 * if (false) { getEventListeners(event).register(new
		 * TimedRegisteredListener(listener, executor, priority, plugin,
		 * ignoreCancelled)); } else {
		 */
