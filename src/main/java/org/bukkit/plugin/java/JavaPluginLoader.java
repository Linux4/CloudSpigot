...
public final class JavaPluginLoader implements PluginLoader {
	...
	public Map<Class<? extends Event>, Set<RegisteredListener>> createRegisteredListeners(Listener listener,
		...
		for (final Method method : methods) {
			...
			/*
			 * if (false) { // Spigot - RL handles useTimings check now eventSet.add(new
			 * TimedRegisteredListener(listener, executor, eh.priority(), plugin,
			 * eh.ignoreCancelled())); } else {
			 */ // CloudSpigot
	...
	public void enablePlugin(final Plugin plugin) {
		...
		if (!plugin.isEnabled()) {
			...
			try {
				...
				// CloudSpigot start - Disable plugins that fail to load
