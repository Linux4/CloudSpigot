...
public class ActivationRange {
	...
	public static boolean initializeEntityActivationState(Entity entity, SpigotWorldConfig config) {
		 ...
		 * entity.activationType == 1 && config.monsterActivationRange == 0 ) || entity
		 * instanceof EntityHuman || entity instanceof EntityProjectile || entity
		 * instanceof EntityEnderDragon || entity instanceof EntityComplexPart || entity
		 * instanceof EntityWither || entity instanceof EntityFireball || entity
		 * instanceof EntityWeather || entity instanceof EntityTNTPrimed || entity
		 * instanceof EntityFallingBlock // CloudSpigot - Always tick falling blocks ||
		...
		return (entity.activationType == 3 && config.miscActivationRange == 0)
				...
				|| entity instanceof EntityTNTPrimed || entity instanceof EntityFallingBlock // CloudSpigot - Always
																								// tick falling blocks
				|| entity instanceof EntityEnderCrystal || entity instanceof EntityFireworks; // CloudSpigot
	}
